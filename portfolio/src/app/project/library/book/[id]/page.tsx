    ...
    return ( 
        <div className={style.container}>
            <div 
                ...
                <img src={mockData.coverImgUrl} /> 
            </div>
            <div className={style.title}>{mockData.title}</div>
            <div className={style.subTitle}>{mockData.subTitle}</div>
            <div className={style.author}>{mockData.author} | {mockData.publisher}</div>
            <div className={style.description}>{mockData.description}</div>
        </div>
    )
};